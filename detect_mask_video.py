...
def detect_and_predict_mask(current_frame, faceNet, maskNet):
	...
	# grab the dimensions of the current_frame to construct a blob
	...
	for i in range(0, detections.shape[2]):
		...
		if confidenceVal > args["confidenceVal"]:
			...
			face = cv2.resize(face, (224, 224))            # resizinge it to 224x224
...
def convertForPost(current_frame):
	...
	with open(r'D:\MIU\12th sem\Final Project\face-mask-detector\detected.jpg', 'rb') as file:
...
def postToWeb(current_frame):
	...
	url = 'http://maskdetectionmahmud.000webhostapp.com/API.php'
...
ap.add_argument("-f", "--face", type=str,
	...
	help="face detector model directory path")
ap.add_argument("-m", "--model", type=str,
	default="mask_detector.model",
	help="trained face mask detector model path")
ap.add_argument("-c", "--confidenceVal", type=float, default=0.5,
	help="minimum probability for filtering")
...
while True:
	...
	for (detectedBox, pred) in zip(locations, predictions):
		...
		cv2.putText(current_frame, label, (startX, startY - 15),
